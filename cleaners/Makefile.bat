...
:help
echo.
echo Copyright (C) 2008-2025 Andrew Ziem and Tobias B. Besemer.  All rights reserved.
echo License is GNU GPL version 3 or later - https://www.gnu.org/licenses/gpl-3.0.html.
